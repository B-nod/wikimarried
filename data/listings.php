...
class Listings
{
 function save($groupId, $title, $urltitle, $description, $main, $pageTitle, $pageKeyword, $metaDescription)
 {
  global $conn;
 ...
 function update($id, $title, $urltitle, $description, $main, $pageTitle, $pageKeyword, $metaDescription)
 {
  global $conn;
 ...
 function getLatestWithLimit($limit)
 {
  ...
  return $conn->exec($sql);
	...
	function getByURLName($urltitle)
	{
		...
		$sql = "SElECT * FROM listings WHERE urltitle = '$urltitle'";
		$result = $conn->exec($sql);
	...
	function getMetaDescription($id)
	{
		...
		$sql = "SElECT metaDescription FROM listings WHERE id = '". cleanQuery($id) ."'";
		$result = $conn->exec($sql);
		$row = $conn -> fetchArray($result);
