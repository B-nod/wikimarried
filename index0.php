...
<!DOCTYPE html>
 ...
 <head>
        ...
        <meta property="og:site_name" content="wikimarried.com"/>
         ...
         <link rel="alternate" href="http://<?php echo $_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]; ?>" hreflang="en-us" /> 
...
<div class="text-right">
	<div class="row">
    <div class="col-md-5 text-left"><a href="http://<?php echo $_SERVER["HTTP_HOST"]; ?>" class="active"><img src="images/logo-small.png" alt="<?php echo $title; ?>" title="<?php echo $title; ?>"></a></div>
...
<div id="top_position">
        ...
        <div id="navbar-collapse-1" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown"> <a href="http://<?php echo $_SERVER["HTTP_HOST"]; ?>" class="active"><i class="fa fa-home"></i></a></li>
...
<script type="text/javascript">
    (function(d) {
      ...
      <div class="col-md-4">
     <a href="<?php echo $r['urltitle']; ?>.html"> <img src="http://i2.wp.com/www.wikimarried.com/<?php echo is_file(CMS_BLOGS_DIR.$r["filename"]) ? CMS_BLOGS_DIR.$r['filename'] : 'images/logo-small.png'; ?>?resize=93,93" class="img-responsive"  alt="<?php echo $r['blog_title']; ?>"></a> 
      </div>
