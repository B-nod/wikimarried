                            ...
                            <tr>
                              ...
                              <select name="position" class="list1"<?php if($mode!="edit"){?> onchange="this.form.submit()<?php }?>">
                                  <option value="">Select Position</option>
																	...
																	<option value="left" <?php if($position == "left") echo " selected"; ?>>Adsense Left</option>
                                  <option value="middle"<?php if($position == "middle") echo " selected"; ?>>Middle [W = 270, H = 156]</option>
																	<option value="top"<?php if($position == "top") echo " selected"; ?>>Content top [Width = 300]</option>
																	<option value="bottom"<?php if($position == "bottom") echo " selected"; ?>>Content Bottom [W = 468, H = 60]</option>
                                </select>
