...
<div>
  ...
  <?php
	...
	<span style="padding-right:27px;">Page Title : </span> <span>
  <input type="text" name="listPageTitle" value="<?php echo $listRow['pageTitle']; ?>" class="text" />
  </span> <br class="clearboth" />
	<span style="padding-right:5px;">Page Keyword : </span> <span>
  <input type="text" name="listPageKeyword" value="<?php echo $listRow['pageKeyword']; ?>" class="text" />
  </span> 
   <br class="clearboth" />
	<span style="padding-right:1px; vertical-align:top">Meta Description</span> <span>
    <textarea name="listMetaDescription" class="text"><?php echo $listRow['metaDescription'];?></textarea>

  </span> 
  
  <br class="clearboth" />
  <span style="padding-right:54px;">Title : </span> <span>
  <input type="text" name="listTitle" id="listTitle" tabindex="1" value="<?php echo $listRow['title']; ?>" class="text" onchange="copySame('listUrlTitle', this.value);" />
	<br class="clearboth" />
	<span style="padding-right:29px;">Alias Title : </span> <span>
...
<textarea name="listDescription"><?php echo $listRow['description']; ?></textarea>
  </span> <br class="clearboth" />
