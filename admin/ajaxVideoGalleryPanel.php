...
<div id="uploadVideoHolder">
  ...
  <div style="float:left;">
    <input type="text" name="videoUrl[]" class="text" /> <strong>[eg. http://www.youtube.com/v/1425WRE54]</strong>
  </div>
  <hr style="clear: both;">
</div>
<?php
...
<div>
  <?php
	...
	{
	?>
  <div style="float: left; width: 335px; height: 220px; border: 1px solid; overflow:hidden; padding:5px;">
    <div align="right">
