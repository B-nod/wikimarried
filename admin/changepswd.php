...
if(isset($_POST['btnSubmit']))
{
 ...
 if(isset($_SESSION['sessUsername']))
 {
  if(empty($errMsg))
  {
   $chPsw = $users -> updatePasswordEmail($_SESSION['sessUserId'],$npsw,$email);
   if($chPsw)
   {
                                ...
                                <table border="0" width="100%" cellpadding="2" cellspacing="0" class="tahomabold11">
                                  ...
                                  <tr>
                                    ...
                                    <td width="64%" valign="top"><div align="left">
                                        <input name="old_psw" type="password" class="text" required>  
                                      </div></td>
                                  </tr>
                                  <tr>
                                    <td align="left" valign="top"><div align="right">Enter New Password :</div></td>
                                    <td valign="top"><div align="left">
                                        <input name="new_psw" type="password" class="text" required>
                                      </div></td>
                                  </tr>
                                  <tr>
                                    <td align="left" valign="top"><div align="right">Confirm New Password :</div></td>
                                    <td valign="top"><div align="left">
                                        <input name="conf_new_psw" type="password" class="text" required>
                                      </div></td>
                                  </tr>
                                  
                                   <tr>
                                    <td align="left" valign="top"><div align="right">Your Email :</div></td>
                                    <td valign="top"><div align="left">
                                  ...
                                  <tr>
                                    ...
                                    <td valign="top" align="left"><div align="left">
                                        <input name="btnSubmit" type="submit" class="btn btn-danger" value="UPDATE">
                                      </div></td>
                                  </tr>
