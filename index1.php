...
if(!in_array("NP",$res) ||  strpos($url,'?india')==true)
$g_add = true;
else 
$g_add = false;	
...
<!DOCTYPE html>
 ...
 <head>
		...
		<meta name="google-site-verification" content="Y4qu-JCC8i0AEGxv8jOirJoSC48vrJOFT5_qu_PAzeo" />      
        <meta name="keywords" content="<?php echo $keyword; ?> <?php if(isset($_GET['page'])) echo " - Page ".$_GET['page']; ?>" />
        <meta name="description" content="<?php echo $description; ?> <?php if(isset($_GET['page'])) echo " - Page ".$_GET['page']; ?>" />
        ...
        <meta property="og:url" content="https://www.wikimarried.com/<?php echo (count($_GET)==0) ? "" :  $_GET['title'].".html"; ?>"/>
        ...
        <?php if(isset($_GET['blogId'])){
         ...
         <meta property="og:image" content="https://www.wikimarried.com/<?php echo CMS_BLOGS_DIR.$row['filename']; ?>"/>
            <?php } else { ?>
        ...
        <meta property="og:site_name" content="wikimarried.com"/>
         ...
         <link rel="alternate" href="https://<?php echo $_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]; ?>" hreflang="en-us" /> 
...
<div class="text-right">
	<div class="row">
    <div class="col-md-5 text-left"><a href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>" class="active"><img src="images/logo-small.png" alt="<?php echo $title; ?>" title="<?php echo $title; ?>"></a></div>
...
<div id="top_position">
        ...
        <div id="navbar-collapse-1" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown"> <a href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>" class="active"><i class="fa fa-home"></i></a></li>
                 
            
      
            <li class="dropdown" style="position:relative;"><a href="celebrity-gossip.html" >  Celebrity Gossip  </a></li>
            
           
            
            <li class="dropdown"><a href="entertainment.html"> 
 Entertainment  </a></li>
            
            <li class="dropdown"><a href="net-worth.html" style="position:relative;"> Net Worth  </a></li>
            
            <li class="dropdown"><a href="salary.html" style="position:relative;">  	Salary  </a></li>
            <li class="dropdown"><a href="wiki.html" style="position:relative;">  	Wiki  </a></li>
            <li class="dropdown"><a href="biography.html" style="position:relative;">  	 	Biography  </a></li>
           
           <li class="dropdown" style="width:250px;"></li>
...
<div class="row">
  ...
  <a href="<?php  echo $r['urltitle']; ?>.html">  <?php if(is_file(CMS_BLOGS_DIR.$r['filename'])){ ?>  <img src="https://i2.wp.com/www.wikimarried.com/<?php echo CMS_BLOGS_DIR.$r['filename']; ?>?resize=165,175" class="img-responsive to_fade wobble-horizontal fadeIn"  alt="<?php echo $r['blog_title']; ?>"> <?php } else { ?> <img src="images/no-image.jpg" class="img-responsive" alt="image not available" /> <?php } ?> </a> 
    </div>
<div class="col-md-9 col-sm-9 descr">
<h2> <a href="<?php  echo $r['urltitle']; ?>.html"> <?php echo $r['blog_title']; ?> </a>    </h2>

<div class="post-info">
<time class="thetime" datetime="<?php echo $r['blog_published_Date']; ?>"><i class="fa fa-calendar"></i> <?php $date =  date_create($r['blog_published_Date']);
echo date_format($date, 'l, F jS, Y '); ?></time> <span><i class="fa fa-tags"></i> <a href="<?php echo $row['category_title']; ?>.html"><?php echo $row["title"]; ?></a> </span> 
</div>
...
<script type="text/javascript">
    (function(d) {
       ...
       <?php if(count($_GET)==0)
	   $limit = 7; elseif(isset($_GET["page"])) $limit = 7; else $limit = 0; ?>
      ...
      <div class="col-md-4">
     <a href="<?php echo $r['urltitle']; ?>.html"> <img src="https://i2.wp.com/www.wikimarried.com/<?php echo is_file(CMS_BLOGS_DIR.$r["filename"]) ? CMS_BLOGS_DIR.$r['filename'] : 'images/logo-small.png'; ?>?resize=93,93" class="img-responsive"  alt="<?php echo $r['blog_title']; ?>"></a> 
      </div>
      <div class="col-md-8"><h3><a href="<?php echo $r['urltitle']; ?>.html"><?php echo $r['blog_title']; ?></a></h3>
      	<p><time datetime="<?php echo $r['blog_published_Date']; ?>">— <?php $date =  date_create($r['blog_published_Date']);
echo date_format($date, 'F jS, Y '); ?></time></p>
      </div>
...
<footer>
        <div class="container">
        <div id="footer">
        <p class="text-center">&copy; <?php echo date("Y"); ?>. All Right Reserved. www.wikimarried.com<br />By using wikimarried.com you agree to our Terms of Use and Privacy Policy. Published contents by users are under Creative Commons License.</br>  Developed By: <a target="_blank" style="color:#EFEFEF;">Wikimarried</a> 
