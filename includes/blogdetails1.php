...
<div class="welcome">
 ...
 <ol class="breadcrumb">
  <li><a href="https://www.wikimarried.com/">Home</a></li>
...
(adsbygoogle = window.adsbygoogle || []).push({});
 ...
 <?php if(is_file(CMS_BLOGS_DIR.$groupRow['filename'])){ ?><img src="https://i2.wp.com/wikimarried.com/files/blogs/<?php echo $groupRow['filename']; ?>?resize=250,250" class="img-responsive"   alt="<?php echo $keyword; ?>">
...
<?php }  ?>
 ...
 <div class="row">
    ...
    <div class="col-md-4 col-sm-4">
    <i class="fa fa-comments"></i> <a href="https://<?php echo $_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]; ?>#disqus_thread" class="comment"></a> 
    </div>
