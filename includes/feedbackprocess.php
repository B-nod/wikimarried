...
if(isset($_POST['btnFeedback']))
{
	if($_SESSION['security_code'] == $_POST['security_code'] && !empty($_SESSION['security_code']))
	{
		...
		{
		$subject = "Inquiry details on ". WEBSITE;
		$msg = '
		  ...
		  <div>
            <label> <span style="padding-right:100px;">Country :</span>' . $txtcountry .'</label>
          </div>
		  <div>
            <label> <span style="padding-right:100px;">Comment :</span>' . $txtcomment .'</label>
          </div>
		  <div>
            <label> <span style="padding-right:100px;">Trip Name :</span>' . $txtTripName .'</label>
          </div>
		...
		$feedbackmsg = "Thank you for your enquiry. We will contact you at our earliest.";
		$success = TRUE;
		}	
		else
