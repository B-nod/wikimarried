...
<div class="welcome" style="padding:0 20px;">
  ...
  <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="txtTripName" class="form-control" value="<?php echo $_POST['txtTripName']; ?>"  size="25"/></td>
    </tr>
    
    <tr>
      <td width="30%">Name <span class="red">*</span> <br /><span class="inquiry_sub">Add your name</span></td>
      <td><input type="text" name="txtname" class="form-control" value="<?php echo $_POST['txtname']; ?>"  size="25" /></td>
    </tr>
    <tr>
      <td class="npText">Email <span class="red">*</span> <br /><span class="inquiry_sub">Add a valid address</span></td>
      <td><input type="text" name="txtemail" class="form-control" value="<?php echo $_POST['txtemail']; ?>"  size="25" /></td>
    </tr>
    <tr>
      <td class="npText">Telephone <span class="red">*</span> <br /><span class="inquiry_sub">Number only</span></td>
      <td><input type="text" name="txtphone" class="form-control" value="<?php echo $_POST['txtphone']; ?>"  size="25" /></td>
    </tr>
    
    <tr>
      <td>Country <br /><span class="inquiry_sub">Add your country</span></td>
      <td><input type="text" name="txtcountry" class="form-control" value="<?php echo $_POST['txtcountry']; ?>"   size="25"/></td>
    </tr>
    <tr>
      <td valign="top" class="npText">Inquiry <span class="red">*</span> <br /><span class="inquiry_sub">Write your inquiries</span></td>
      <td><textarea name="txtcomment" cols="" rows="" class="form-control"><?php echo $_POST['txtcomment']; ?></textarea></td>
    </tr>
    <br />
    <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input id="security_code" name="security_code" type="text" maxlength="6" class="form-control" style="width:50%;" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input name="btnFeedback" type="submit" value="Submit" class="btn  btn-primary" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
