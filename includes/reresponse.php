<?php
$submit_button_name = "submitResponse".$r1['id'];
...
<?php
	if(!empty($success)){
	?>
<div class="alert alert-success" role="alert" style="width:50%; margin-top:10px; font-size:22px; color:green;"><?php echo $success; ?></div>
<?php } ?>
<?php
	if(!empty($error)){
	?>
    
    <div class="alert alert-danger" role="alert" style="width:50%; margin-top:10px; font-size:22px; color:red;"><?php echo $error; ?></div>
    <?php	
	}
 ?>
...
<div class="col-md-6"><div class="form-group-sm"><label for="coments">Your Comments: </label><textarea name="comments" class="form-control" style="height:160px;"></textarea></div></div><div class="clearfix"></div>
