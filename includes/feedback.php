...
<div class="welcome">
  ...
  <table width="500" border="0" cellspacing="0" cellpadding="0" id="enquiry_table">
  <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="txtTripName" class="text" value="<?php echo $_POST['txtTripName']; ?>"  size="25"/></td>
    </tr>
