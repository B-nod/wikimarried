...
(adsbygoogle = window.adsbygoogle || []).push({});
 ...
 <?php if(is_file(CMS_BLOGS_DIR.$groupRow['filename'])){ ?><img src="https://www.wikimarried.com/files/blogs/<?php echo $groupRow['filename']; ?>?resize=250,250" class="img-responsive"   alt="<?php echo $keyword; ?>">
