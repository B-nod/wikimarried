...
function extendTripBox()
{  newDiv = document.createElement("div");
	str = " <div class='alu'><div style='width:385px; float:left;'> Title: <input type='text' name='title[]'></div>";
	str += "<div style='width:385px; float:left;'>Link: <input type='text' name='link[]'></div></div><div style='clear:both;'></div>";
	newDiv.innerHTML = str;
	document.getElementById('insertIntoDiv').appendChild(newDiv);
}
...
function copySame(id,divId,value)
{
	...
	xmlHttp.open("GET",'formaturl.php?value='+ value+"&id="+id,true);
...
function checkUrlName(id, val, div)
{
	...
	xmlHttp.open("GET",'checkurlname.php?id=' + id + '&value='+ val,true);
